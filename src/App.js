...
function App() {
	return (
		...
		<table>
			...
			<tr>
				<td className="font-size">
					...
					<span className="vertical-divider"></span>Fondateur & Développeur
					Front-end
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td className="font-size">
					...
					<a href="tel:+33634172014" className="color-link">
						06 34 17 20 14
					</a>
				</td>
			</tr>
		...
		// 			/>
		// 		</td>
		// 		<td className="bold keryan margin-right">Kevin Kotcherga</td>
		// 	</tr>
		// 	<tr>
		// 		<td className="font-size">
		// 			<span className="bold">Devinnet</span>
		...
		// 		<td>
		// 			<a
		// 				href="https://www.kevinkotcherga.xyz/"
		// 				target="_blank"
		// 				rel="noreferrer"
		// 			>
		// 				<img
		...
		// 			</a>
		// 			<a
		// 				href="https://github.com/kevinkotcherga"
		// 				target="_blank"
		// 				rel="noreferrer"
		// 			>
		// 				<img
		...
		// 			<a
		// 				href="https://www.linkedin.com/in/kevinkotcherga/"
		// 				target="_blank"
		// 				rel="noreferrer"
		// 			>
		// 				<img
